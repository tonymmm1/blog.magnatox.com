;<?php http_response_code(403) ; config file for PrivateBin
;
...
sizelimit = 10485760 ;(1024^2 * 10 = 10 Mebibytes)
...
class = Database
[model_options]
;      - MYSQL_HOST=privatebin_db	
;      - MYSQL_DATABASE=privatebin
;      - MYSQL_USER=privatebin
;      - MYSQL_PASSWORD=
dsn = "mysql:host=privatebin_db;dbname=privatebin;charset=UTF8"
tbl = "privatebin_"	; table prefix
usr = "privatebin"
pwd = "(insert password)" ;replace (insert password) with MYSQL_PASSWORD
